...
async def on_message(message):
    ...
    dadJokes = ["Today, my son asked ~Can I have a book mark?~ and I burst into tears. 11 years old and he still doesn't know my name is Brian.",
    ...
    id = client.get_guild(750780520975040713)
...
client.run("NzUwNzgwMDIzMjY2NDc2MDQz.X0_gYg.z7EBTak9Hpj_SIr-cO92DZLe--s")